        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2"> 
                <div class="card-body">
                  <form role="form" method="POST" action="user_ctrl">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <input type="password" name="password" value="<?= $data[0]->password;?>" class="form-control">
                    </div>
                    <div class="text-center">
                      <button type="submit" name="action"  value = "update" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">UPDATE</button>
                    </div>
